...
import com.nonzeroapps.android.whatisnew.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NewItemDialog.init().setDialogTitle("New Features of 1.2.0 Version!").setItems(arrayList).showDialogIfConditionsSuitable(this);
